  ...
  factory = function(id) {
    ...
    var
      ...
      refreshPeer = function(peer) {
        ...
        peer.bma = peer.bma || newLightBMA(peer);

        // Get current block
        return peer.bma.blockchain.current()
          .then(function(block) {
          ...
          .then(function(peer) {
            ...
            if (peer.uid) {
              jobs.push(peer.bma.blockchain.stats.hardship({pubkey: peer.pubkey})
                .then(function (res) {
            ...
            // Get Version
            jobs.push(peer.bma.node.summary()
              .then(function(res){
